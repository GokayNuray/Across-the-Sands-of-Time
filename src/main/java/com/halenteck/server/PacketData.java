...
public class PacketData {
     ...
     * Player data is in the form of {byte id, boolean isRedTeam, String name, float[5] x, y, z, yaw, pitch, byte characterId, int weapon, int attackPower, byte kill, byte death}.
     */
